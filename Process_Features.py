...
def Load_Data(
    ...
    change_key(opensignals_data, "time_Opensignals", "Time"), change_key(opensignals_data, "CH1", "ECG"),
    change_key(opensignals_data, "CH2", "EDA"), change_key(opensignals_data, "CH3", "RESP")
